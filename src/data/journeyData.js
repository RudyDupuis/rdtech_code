...
export const journeyData = [
  {
    type: "study",
    name: "Alternance à Grand Poitiers Communauté Urbaine",
    title: null,
    ...
    desc: null,
    smallDesc:
      "Développeur web sur le projet [SI]Lab v2, une application web de gestion pour les agents des collectivités territoriales",
    techUsed: null,
    projectLink: null,
    codeLink: null,
    docLink: null,
  ...
  {
    type: "study",
    name: "Bac + 4 | Concepteur Développeur d'Applications",
    title: null,
    date: "Mars 2024 - Mars 2025",
    dateNumb: [3, 2024],
    img: null,
    desc: null,
    smallDesc:
      "Formation au sein de l'école ENI ecole informatique. Code RNCP : RNCP37873 (EN COURS)",
    techUsed: null,
    projectLink: null,
    codeLink: null,
    docLink: null,
  },
  {
    ...
    dateNumb: [3, 2024],
    img: "/journey/codetogether.png",
    desc: "Code Together est une application web visant à aider les développeurs à collaborer en équipe. Ils peuvent proposer ou rejoindre des projets de groupe. J'ai occupé le rôle de chef de projet et j'ai également géré un environnement CI/CD opérationnel grâce à Docker et VSCode.",
    smallDesc:
      "Création d'une application web visant à aider les développeurs à collaborer en équipe",
    techUsed: [
      "Html",
      "Css",
      "Sass",
  ...
  },
  {
    ...
    date: "Octobre 2023",
    dateNumb: [10, 2023],
    img: "/journey/pokedex.png",
    desc: "En dehors de ma formation à l'ENI, j'ai entrepris un projet personnel passionnant : la création d'un Pokedex. Ce projet m'a donné l'occasion de mettre en pratique mes compétences en développement web, notamment en utilisant le framework Vue.js. Ayant récemment acquis des connaissances sur Vue.js, j'ai décidé de relever un défi personnel en mettant en place un Pokedex fonctionnel en utilisant l'API PokéApi.\n\nL'esthétique de l'interface est restée fidèle à un style épuré et convivial, tout en mettant en avant les informations essentielles sur les Pokémon. Pour ajouter une dimension de défi à ce projet personnel, je me suis fixé une limite stricte de trois jours pour le réaliser, une limite que j'ai réussi à respecter.",
    smallDesc: "Création d'un pokedex avec l'api PokéApi",
    techUsed: [
      "Html",
      "Css",
      "Sass",
    ...
    projectLink: "https://pokedex-rdtech.netlify.app/",
    codeLink: "https://github.com/RudyDupuis/pokedex-vuejs",
    docLink: null,
  },
  {
    type: "project",
  ...
  },
  {
    ...
    desc: null,
    smallDesc:
      "Formation au sein de l'école ENI ecole informatique. Code RNCP : RNCP31114",
    techUsed: null,
    projectLink: null,
    codeLink: null,
    docLink: null,
